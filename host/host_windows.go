...
import (
	...
	"github.com/xurwxj/gopsutil/process"
...
func HostIDWithContext(ctx context.Context) (string, error) {
	// there has been reports of issues on 32bit using golang.org/x/sys/windows/registry, see https://github.com/xurwxj/gopsutil/pull/312#issuecomment-277422612
